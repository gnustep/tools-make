...
ALL_BRIDGET_CPP_FLAGS =	$(ALL_CPPFLAGS) \
	$(ADDITIONAL_INCLUDE_DIRS) $(AUXILIARY_INCLUDE_DIRS) -I. $(SYSTEM_INCLUDES) \
...
before-$(TARGET)-all::
	...
	@(opentool bridget $(JAVA_JOBS_FILES) -P $(ALL_BRIDGET_CPP_FLAGS))
else
before-$(TARGET)-all::
	@echo "Building Java classes...";
	$(BRIDGET) $(JAVA_JOBS_FILES) -P $(ALL_BRIDGET_CPP_FLAGS)
endif
