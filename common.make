...
ifeq ($(GNUSTEP_FLATTENED),)
  GNUSTEP_FRAMEWORKS_LIBRARIES \
	= $(GNUSTEP_FRAMEWORKS_LIBRARIES_ROOT)/$(GNUSTEP_TARGET_LDIR)
  GNUSTEP_LIBRARIES          = $(GNUSTEP_LIBRARIES_ROOT)/$(GNUSTEP_TARGET_LDIR)
else
  GNUSTEP_FRAMEWORKS_LIBRARIES = $(GNUSTEP_FRAMEWORKS_LIBRARIES_ROOT)
  GNUSTEP_LIBRARIES          = $(GNUSTEP_LIBRARIES_ROOT)
endif
