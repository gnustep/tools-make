...
ifneq ($(GNUSTEP_INSTALLATION_DIR),)
  ...
  GNUSTEP_UTILITIES            = $(GNUSTEP_INSTALLATION_DIR)/Applications/Utilities
  ...
  GNUSTEP_CORE_SERVICES        = $(GNUSTEP_LIBRARY)/CoreServices
  GNUSTEP_CORE_SERVICES_APPS   = $(GNUSTEP_LIBRARY)/CoreServices/Applications
  ...
  GNUSTEP_UTILITIES            = $(MAYBE_DESTDIR)$(GNUSTEP_$(GNUSTEP_INSTALLATION_DOMAIN)_UTILITIES)
  ...
  GNUSTEP_CORE_SERVICES        = $(MAYBE_DESTDIR)$(GNUSTEP_$(GNUSTEP_INSTALLATION_DOMAIN)_CORE_SERVICES)
  GNUSTEP_CORE_SERVICES_APPS   = $(MAYBE_DESTDIR)$(GNUSTEP_$(GNUSTEP_INSTALLATION_DOMAIN)_CORE_SERVICES_APPS)
