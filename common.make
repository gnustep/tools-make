...
ifeq ($(GNUSTEP_FLATTENED),)
  GNUSTEP_SYSTEM_FRAMEWORKS_LIBRARIES_FLAGS = \
        -L$(GNUSTEP_SYSTEM_FRAMEWORKS_LIBRARIES_ROOT)/$(GNUSTEP_TARGET_LDIR)

  GNUSTEP_SYSTEM_LIBRARIES_FLAGS = \
    -L$(GNUSTEP_SYSTEM_LIBRARIES_ROOT)/$(GNUSTEP_TARGET_LDIR) \
    -L$(GNUSTEP_SYSTEM_LIBRARIES_ROOT)/$(GNUSTEP_TARGET_DIR)

else
  GNUSTEP_SYSTEM_FRAMEWORKS_LIBRARIES_FLAGS = \
        -L$(GNUSTEP_SYSTEM_FRAMEWORKS_LIBRARIES_ROOT)

  GNUSTEP_SYSTEM_LIBRARIES_FLAGS = -L$(GNUSTEP_SYSTEM_LIBRARIES_ROOT)
endif

  GNUSTEP_SYSTEM_HEADERS_FLAGS = -I$(GNUSTEP_SYSTEM_HEADERS)
  # FIXME: parse -framework keyword
  GNUSTEP_SYSTEM_FRAMEWORKS_HEADERS_FLAGS = -I$(GNUSTEP_SYSTEM_FRAMEWORKS_HEADERS)
...
ifneq ($(GNUSTEP_LOCAL_ROOT),)
  ...
  ifeq ($(GNUSTEP_FLATTENED),)
	...
	-L$(GNUSTEP_LOCAL_FRAMEWORKS_LIBRARIES_ROOT)/$(GNUSTEP_TARGET_LDIR)

    GNUSTEP_LOCAL_LIBRARIES_FLAGS = \
      -L$(GNUSTEP_LOCAL_LIBRARIES_ROOT)/$(GNUSTEP_TARGET_LDIR) \
      -L$(GNUSTEP_LOCAL_LIBRARIES_ROOT)/$(GNUSTEP_TARGET_DIR)
  else
    GNUSTEP_LOCAL_FRAMEWORKS_LIBRARIES_FLAGS = \
	-L$(GNUSTEP_LOCAL_FRAMEWORKS_LIBRARIES_ROOT)

    GNUSTEP_LOCAL_LIBRARIES_FLAGS = -L$(GNUSTEP_LOCAL_LIBRARIES_ROOT)
  endif

  GNUSTEP_LOCAL_HEADERS_FLAGS = -I$(GNUSTEP_LOCAL_HEADERS)
  # FIXME: parse -framework keyword
  GNUSTEP_LOCAL_FRAMEWORKS_HEADERS_FLAGS = -I$(GNUSTEP_LOCAL_FRAMEWORKS_HEADERS)
endif
...
ifneq ($(GNUSTEP_USER_ROOT),)
  ...
  ifeq ($(GNUSTEP_FLATTENED),)
	...
	-L$(GNUSTEP_USER_FRAMEWORKS_LIBRARIES_ROOT)/$(GNUSTEP_TARGET_LDIR)

    GNUSTEP_USER_LIBRARIES_FLAGS   = \
      -L$(GNUSTEP_USER_LIBRARIES_ROOT)/$(GNUSTEP_TARGET_LDIR) \
      -L$(GNUSTEP_USER_LIBRARIES_ROOT)/$(GNUSTEP_TARGET_DIR)
  else
    GNUSTEP_USER_FRAMEWORKS_LIBRARIES_FLAGS = \
	-L$(GNUSTEP_USER_FRAMEWORKS_LIBRARIES_ROOT)
    GNUSTEP_USER_LIBRARIES_FLAGS   = -L$(GNUSTEP_USER_LIBRARIES_ROOT)
  endif
...
ifneq ($(GNUSTEP_NETWORK_ROOT),)
  ...
  ifeq ($(GNUSTEP_FLATTENED),)
    GNUSTEP_NETWORK_LIBRARIES_FLAGS = \
      -L$(GNUSTEP_NETWORK_LIBRARIES_ROOT)/$(GNUSTEP_TARGET_LDIR) \
      -L$(GNUSTEP_NETWORK_LIBRARIES_ROOT)/$(GNUSTEP_TARGET_DIR)

    GNUSTEP_NETWORK_FRAMEWORKS_LIBRARIES_FLAGS = \
	-L$(GNUSTEP_NETWORK_FRAMEWORKS_LIBRARIES_ROOT)/$(GNUSTEP_TARGET_LDIR)
  else
    GNUSTEP_NETWORK_LIBRARIES_FLAGS = -L$(GNUSTEP_NETWORK_LIBRARIES_ROOT)

    GNUSTEP_NETWORK_FRAMEWORKS_LIBRARIES_FLAGS = \
	-L$(GNUSTEP_NETWORK_FRAMEWORKS_LIBRARIES_ROOT)
  endif
