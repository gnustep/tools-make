...
ifeq ($(GNUSTEP_FLATTENED),)
  GNUSTEP_SYSTEM_FRAMEWORKS_LIBRARIES = \
        $(GNUSTEP_SYSTEM_FRAMEWORKS_LIBRARIES_ROOT)/$(GNUSTEP_TARGET_LDIR)
...
ifneq ($(GNUSTEP_LOCAL_ROOT),)
  ...
  ifeq ($(GNUSTEP_FLATTENED),)
	...
	$(GNUSTEP_LOCAL_FRAMEWORKS_LIBRARIES_ROOT)/$(GNUSTEP_TARGET_LDIR)
...
ifneq ($(GNUSTEP_USER_ROOT),)
  ...
  ifeq ($(GNUSTEP_FLATTENED),)
	...
	$(GNUSTEP_USER_FRAMEWORKS_LIBRARIES_ROOT)/$(GNUSTEP_TARGET_LDIR)
  ...
  GNUSTEP_USER_FRAMEWORKS_LIBRARIES_FLAGS   = -L$(GNUSTEP_USER_FRAMEWORKS_LIBRARIES)
  # FIXME: parse -framework keyword
...
ifneq ($(GNUSTEP_NETWORK_ROOT),)
  ...
  ifeq ($(GNUSTEP_FLATTENED),)
	...
	$(GNUSTEP_NETWORK_FRAMEWORKS_LIBRARIES_ROOT)/$(GNUSTEP_TARGET_LDIR)
  else
